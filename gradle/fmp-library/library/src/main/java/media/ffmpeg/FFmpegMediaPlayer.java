...
public class FFmpegMediaPlayer
{
    ...
    private final static String IMEDIA_PLAYER = "media.ffmpeg.IMediaPlayer";
    ...
    public interface OnPreparedListener{void onPrepared(FFmpegMediaPlayer mp);}
    public void setOnPreparedListener(OnPreparedListener listener){mOnPreparedListener = listener;}
    private OnPreparedListener mOnPreparedListener;
    public interface OnCompletionListener{void onCompletion(FFmpegMediaPlayer mp);}
    public void setOnCompletionListener(OnCompletionListener listener){mOnCompletionListener = listener;}
    private OnCompletionListener mOnCompletionListener;
    public interface OnBufferingUpdateListener{void onBufferingUpdate(FFmpegMediaPlayer mp, int percent);}
    public void setOnBufferingUpdateListener(OnBufferingUpdateListener listener){mOnBufferingUpdateListener = listener;}
    private OnBufferingUpdateListener mOnBufferingUpdateListener;
    public interface OnSeekCompleteListener{public void onSeekComplete(FFmpegMediaPlayer mp);}
    public void setOnSeekCompleteListener(OnSeekCompleteListener listener){mOnSeekCompleteListener = listener;}
    private OnSeekCompleteListener mOnSeekCompleteListener;
    public interface OnVideoSizeChangedListener{public void onVideoSizeChanged(FFmpegMediaPlayer mp, int width, int height);}
    ...
    public interface OnTimedTextListener{public void onTimedText(FFmpegMediaPlayer mp, TimedText text);}
    public void setOnTimedTextListener(OnTimedTextListener listener){mOnTimedTextListener = listener;}
    private OnTimedTextListener mOnTimedTextListener;
    public static final int MEDIA_ERROR_UNKNOWN = 1;
    public static final int MEDIA_ERROR_SERVER_DIED = 100;
    public static final int MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK = 200;
    public interface OnErrorListener{boolean onError(FFmpegMediaPlayer mp, int what, int extra);}
    ...
    public interface OnInfoListener{boolean onInfo(FFmpegMediaPlayer mp, int what, int extra);}
